...
function App() {
  ...
  return (
    <div className="App list-group-item  justify-content-center align-items-center mx-auto" style={{"width":"500px", "backgroundColor":"white", "marginTop":"15px"}} >
      ...
      <h6 className="card text-dark bg-warning py-1 mb-0" >Copyright 2023, All rights reserved Solomon Kim &copy;</h6>
    </div>
  )
}
